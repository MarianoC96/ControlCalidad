    ...
    <>
          ...
          <div className="brand-wrapper">
            ...
            {!isCollapsed && (
              <div className="brand-details">
                <span className="brand-name">Control Calidad</span>
      ...
      <style jsx>{`
                ...
                .sidebar {
                    ...
                    left: 0;
                    bottom: 0;
                    width: 280px; /* Incrementado para asegurar que todo el texto sea visible */
                    background-color: #003d1f; /* Verde más claro y vibrante según feedback */
                    color: #f1f5f9;
                    z-index: 1002;
                    display: flex;
                ...
                .sidebar-header {
                    ...
                    display: flex;
                    align-items: center;
                    padding: 0 1.25rem; /* Ligeramente reducido el padding lateral */
                ...
                .brand-wrapper {
                    display: flex;
                    align-items: center;
                    gap: 0.5rem; /* Reducido para dar más espacio al texto */
                }

                .logo-box {
                    min-width: 85px; /* Ligeramente reducido */
                    height: 38px;
                    background: #ffffff;
                ...
                .brand-name {
                    font-weight: 800;
                    font-size: 1.05rem; /* Tamaño original de la Imagen 2 */
                    white-space: nowrap;
                    color: #ffffff;
                ...
                .nav-link {
                    ...
                    padding: 0 18px;        /* Botones más anchos internamente */
                    text-decoration: none;
                    color: #94a3b8;
                    border-radius: 12px;    /* Bordes más redondeados */
                    transition: all 0.2s ease;
                    position: relative;
                    height: 46px;           /* Altura original cómoda */
                    width: 100%;
                ...
                .nav-text {
                    font-weight: 500;
                    font-size: 0.95rem; /* Legibilidad correcta de la Imagen 2 */
                    white-space: nowrap;
                    opacity: 1;
                    line-height: 1.2;
                    letter-spacing: 0.01em;
